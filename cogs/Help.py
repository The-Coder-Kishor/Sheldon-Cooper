...
from   cogs import DisplayName, Message, FuzzySearch, PickList
...
class Help(commands.Cog):
	...
	async def help(self, ctx, *, command = None):
		...
		desc = "```\nGet more info with \"{}help Cog_or_command\".\nCog are case-sensitive while commands are not.\n Now you can use {}suggest to give us suggestions and {}dmhelp for getting help in the dm\n```".format(self._get_prefix(ctx),self._get_prefix(ctx),self._get_prefix(ctx))
